...
public class MainActivity extends AppCompatActivity {
    Button main_btn,edit_btn,on_btn,off_btn,arrow_left,arrow_right;
...
//        lottie animation
        ...
        total_vol_var = findViewById(R.id.total_vol_var);
...
//        thread.start();
        ...
        edit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edit_btn.startAnimation(main_btn_anim);
                on_edit_click();
        ...
        off_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(client.main_pump.get_pump_status()==0) // 0 means pump already off
                    return;
                client.pump_of();
//                do_changes();
            }
        ...
        on_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tank temp_tank = (tank) client.tank_list.get(client.cur_tank_index).getValue();
                if(client.main_pump.get_pump_status()==1) { // 1 means pump already on
...
//                do_changes();
    ...
    public void do_changes(){
        set_variables((tank) client.tank_list.get(client.cur_tank_index).getValue());
    }
    ...
    public void set_variables(tank main_tank){
        ...
        total_vol_var.setText(main_tank.get_total_vol()+"litre");
        if(client.main_pump.get_line_water()==1){
            line_water_var.setText(R.string.a);
        }else{
            line_water_var.setText(R.string.na);
        }
        if(client.main_pump.get_pump_status()==1){
            pump_var.setText(R.string.on);
        }else{
            pump_var.setText(R.string.off);
        }
        if(main_tank.get_status()==1){
            status_var.setText(R.string.filling);
        }else{
            status_var.setText(R.string.nf);
        }
...
//        System.out.println(screenutils.getScreenHeight(this));
    ...
    private void toggleVisibility() {
        if (press_btn_view.getVisibility() == View.VISIBLE) {
            ...
            edit_btn.startAnimation(top_out);
            ...
            edit_btn.startAnimation(top_in);
